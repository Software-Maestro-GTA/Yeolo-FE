...
export function Footer({ className = '' }: FooterProps) {
  ...
  const partnerMailSubject = encodeURIComponent('[여로] 비즈니스 제휴 및 협업 제안');
  ...
  return (
    <footer className={`w-full bg-[#0d2137] text-white pt-16 pb-12 ${className}`}>
          ...
          <div className="flex gap-14 sm:gap-20">
            ...
            <div className="flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-2.5 text-[13px] text-[#64748b]">
                <li>
                  <a href={partnerMailHref} className="hover:text-white transition-colors">
                    제휴 제안
                  </a>
                </li>
              </ul>
