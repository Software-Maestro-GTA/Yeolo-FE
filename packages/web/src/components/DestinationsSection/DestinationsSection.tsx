...
const DESTINATIONS: DestinationItem[] = [
  ...
  },
  {
    ...
    description: '전통 건축과 아름다운 대나무 숲길, 고요한 평온함이 흐르는 도시',
  ...
  },
  {
    ...
    description: '거리 곳곳이 미술관이 되는 낭만과 로맨스가 흐르는 빛의 예술 도시',
  ...
  },
  {
    ...
    description: '화려한 야시장과 루프탑 바, 오감을 자극하는 동남아 미식의 중심지',
  ...
  },
  {
    ...
    description: '아름다운 지중해 바다와 천재 건축가의 숨결을 동시에 느끼는 여정',
    imageSrc: '/images/dest-barcelona.png',
    tags: ['#가우디투어', '#지중해', '#건축'],
  },
];

export function DestinationsSection({ className = '' }: DestinationsSectionProps) {
  return (
    <section id="destinations" className={`w-full bg-[#f5faf8] py-20 lg:py-24 ${className}`}>
            ...
            >
              ...
              <div className="p-4 flex flex-col gap-3 flex-1 justify-between">
                <div className="flex items-center gap-1.5 text-[#45464c]">
                  ...
                  <p className="text-[13px] font-medium leading-normal truncate" title={dest.description}>
                    {dest.description}
                  </p>
                </div>
