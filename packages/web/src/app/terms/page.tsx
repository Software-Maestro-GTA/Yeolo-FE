...
export const metadata: Metadata = {
  ...
  description: '초개인화 여행 플랫폼 여로(Yeolo)의 서비스 이용약관 안내 페이지입니다.',
};
  ...
  const articles = [
    {
      ...
      content: (
        <p className="text-[14px] text-[#64748b] leading-[1.75]">
          본 약관은 여로(Yeolo, 이하 &quot;회사&quot;)가 제공하는 초개인화 여행 코스 추천 및 일정 관리 서비스(이하 &quot;서비스&quot;)의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          <p>1. &quot;서비스&quot;란 회사가 제공하는 여행 취향 분석, 맞춤 코스 추천, 일정 보관 및 관리 등 제반 기능을 의미합니다.</p>
          <p>2. &quot;이용자&quot;란 본 약관에 동의하고 회사가 제공하는 서비스를 이용하는 회원을 의미합니다.</p>
          <p>3. &quot;계정&quot;이란 이용자의 식별과 서비스 이용을 위하여 Google 등 소셜 계정 연동을 통해 생성된 계정을 의미합니다.</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          ...
          <p>2. 회사는 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있으며, 개정 시 적용일자 및 개정 사유를 명시하여 최소 7일 전 공지합니다.</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          ...
          <p className="mt-1">
            2. 서비스는 연중무휴, 1일 24시간 제공을 원칙으로 하되, 시스템 정기점검 등 기술상의 필요에 따라 일시 중단될 수 있습니다.
          </p>
        </div>
      ),
    },
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>회사의 서비스를 방해하거나 서버 및 시스템에 부하를 유발하는 행위</li>
            <li>회사의 지식재산권을 침해하거나 기타 관계 법령을 위반하는 행위</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          <p>1. 이용자는 언제든지 서비스 내 회원 탈퇴 메뉴를 통해 이용 계약을 해지할 수 있습니다.</p>
          <p>2. 이용자가 본 약관의 의무를 위반한 경우, 회사는 사전 통보 후 서비스 이용을 제한하거나 계약을 해지할 수 있습니다.</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          ...
          <p>2. 서비스에서 제공하는 여행 코스 및 장소 정보는 AI 분석 및 공공/제휴 데이터 기반으로 추천되는 정보이며, 현지 사정(영업시간, 기상, 교통 등)에 따라 변동될 수 있으므로 회사는 이에 대해 고의 또는 중과실이 없는 한 책임을 지지 않습니다.</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 text-[14px] text-[#64748b] leading-[1.75]">
          <p>1. 회사와 이용자 간에 발생한 전자상거래 및 서비스 이용 관련 분쟁에 대해서는 대한민국 법률을 적용합니다.</p>
          <p>2. 서비스 이용과 관련하여 소송이 제기될 경우 회사의 본점 소재지를 관할하는 법원을 전속 관할법원으로 합니다.</p>
        </div>
      ),
    },
    {
          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6">
              <p className="text-[15px] text-[#64748b] leading-[1.75]">
                여로(Yeolo) 서비스를 이용해 주셔서 감사합니다. 본 약관은 이용자가 여로 서비스를 이용함에 있어 필요한 기본 사항들을 규정하고 있으니 주의 깊게 확인해 주시기 바랍니다.
              </p>
